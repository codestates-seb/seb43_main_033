...
export default function Footer() {
      return (
        <div className=" bottom-0 border-t-2 w-screen justify-center grid bg-emerald-700">
        ...
        <nav className=" flex">
          ...
          <div className="box-border pr-12 flex-auto">
            <h5 className="mb-8">
              <a><Link href="/manager">관리자 메뉴 </Link></a>
            </h5>
            <ul className="inline-block align-top text-sm pt-2">
              <li>
                <a className="">
          ...
          <div className="box-border pr-12 flex-auto">
            <h5 className="mb-8">
              <a><Link href="/worker">근로자 메뉴</Link></a>
            </h5>
            <ul className="inline-block align-top text-sm pt-2">
              <li>
                <a>나의 계약</a>
        ...
        <div className="flex flex-col">
          <ul className="flex">
            <li>
              <a className="inline-block align-top text-sm pr-2">
                Blog</a>
            </li>
            <li>
              <a className="inline-block align-top text-sm pr-2">
